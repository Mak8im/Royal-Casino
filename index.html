...
<body>
    ...
    <script>
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data === 'success') {
                    showMessage('Регистрация успешна! Добро пожаловать в казино!', 'success');
                    document.getElementById('registrationForm').reset();
                } else {
                    showMessage('Ошибка регистрации: ' + data, 'error');
                }
            })
            .catch(error => {
        ...
        // Имитация изменения баланса при нажатии на кнопку "Играть"
        document.querySelectorAll('.btn-play').forEach(button => {
            button.addEventListener('click', function() {
                ...
                // Уменьшаем баланс на случайную сумму от 100 до 500
